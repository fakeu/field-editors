...
var styles$2 = {
  ...
  disabled: /*#__PURE__*/emotion.css(_templateObject2 || (_templateObject2 = /*#__PURE__*/_taggedTemplateLiteralLoose(["\n    .CodeMirror {\n      background: ", ";\n      cursor: 'not-allowed';\n    }\n    .CodeMirror-cursors {\n      visibility: hidden !important;\n    }\n    .CodeMirror-scroll,\n    .CodeMirror-sizer,\n    .CodeMirror-lines {\n      cursor: not-allowed;\n    }\n  "])), tokens.gray100)
};
var MarkdownTextarea = /*#__PURE__*/React__default.memo(function (props) {
...
var MarkdownPreview = /*#__PURE__*/React__default.memo(function (props) {
  var _props$previewCompone;

  var className = emotion.cx(styles$5.root, props.minHeight !== undefined ? emotion.css({
    minHeight: props.minHeight
...
function MarkdownConstraints(props) {
  var constraints = fieldEditorShared.ConstraintsUtils.fromFieldValidations(props.sdk.field.validations, props.sdk.field.type);
...
var InsertLinkModal = function InsertLinkModal(_ref) {
  ...
  var _useState = React.useState(selectedText || ''),
      text = _useState[0],
      setText = _useState[1];
...
var SpecialCharacterModalDialog = function SpecialCharacterModalDialog(_ref) {
  ...
  var _useState = React.useState(specialCharacters[0]),
...
var EmbedExternalContentModal = function EmbedExternalContentModal(_ref2) {
  ...
  var _useState = React.useState('https://'),
      url = _useState[0],
      setUrl = _useState[1];

  var _useState2 = React.useState('percent'),
  ...
  var _useState4 = React.useState('100'),
      width = _useState4[0],
...
var ZenModeModalDialog = function ZenModeModalDialog(props) {
  ...
  var _React$useState = React__default.useState((_props$initialValue = props.initialValue) != null ? _props$initialValue : ''),
...
function MarkdownEditor(props) {
  ...
  var _React$useState2 = React__default.useState('editor'),
...
var openMarkdownDialog = function openMarkdownDialog(sdk, previewComponents) {
  return function (options) {
    ...
    if (((_options$parameters = options.parameters) == null ? void 0 : _options$parameters.type) === MarkdownDialogType.cheatsheet) {
      return fieldEditorShared.ModalDialogLauncher.openDialog(options, function () {
      ...
      return fieldEditorShared.ModalDialogLauncher.openDialog(options, function (_ref2) {
        var onClose = _ref2.onClose;
      ...
      return fieldEditorShared.ModalDialogLauncher.openDialog(options, function (_ref3) {
      ...
      return fieldEditorShared.ModalDialogLauncher.openDialog(options, function (_ref4) {
      ...
      return fieldEditorShared.ModalDialogLauncher.openDialog(options, function (_ref5) {
      ...
      return fieldEditorShared.ModalDialogLauncher.openDialog(options, function (_ref6) {
