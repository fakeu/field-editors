...
var createExitBreakPlugin = function createExitBreakPlugin() {
  return createExitBreakPlugin$1({
    options: {
      rules: []
    },
    then: function then(editor) {
...
var _entityTypes;
var entityTypes = (_entityTypes = {}, _entityTypes[BLOCKS.EMBEDDED_ENTRY] = 'Entry', _entityTypes[BLOCKS.EMBEDDED_ASSET] = 'Asset', _entityTypes);
...
var createEmbeddedEntryBlockPlugin = /*#__PURE__*/createEmbeddedEntityPlugin(BLOCKS.EMBEDDED_ENTRY, 'mod+shift+e');
var createEmbeddedAssetBlockPlugin = /*#__PURE__*/createEmbeddedEntityPlugin(BLOCKS.EMBEDDED_ASSET, 'mod+shift+a');
...
var LABELS = (_LABELS = {}, _LABELS[BLOCKS.PARAGRAPH] = 'Normal text', _LABELS[BLOCKS.HEADING_1] = 'Heading 1', _LABELS[BLOCKS.HEADING_2] = 'Heading 2', _LABELS[BLOCKS.HEADING_3] = 'Heading 3', _LABELS[BLOCKS.HEADING_4] = 'Heading 4', _LABELS[BLOCKS.HEADING_5] = 'Heading 5', _LABELS[BLOCKS.HEADING_6] = 'Heading 6', _LABELS);
function ToolbarHeadingButton(props) {
  ...
  var _React$useState2 = useState(BLOCKS.PARAGRAPH),
  ...
  }, /*#__PURE__*/createElement(Menu.Trigger, null, /*#__PURE__*/createElement(Button, {
    size: "small",
    testId: "toolbar-heading-toggle",
    variant: "transparent",
    endIcon: /*#__PURE__*/createElement(ChevronDownIcon, null),
    isDisabled: props.isDisabled,
    onClick: function onClick() {
      return someHeadingsEnabled && setOpen(!isOpen);
    }
  }, LABELS[selected])), /*#__PURE__*/createElement(Menu.List, {
    testId: "dropdown-heading-list"
  }, ' ', Object.keys(LABELS).map(function (nodeType) {
    return nodeTypesByEnablement[nodeType] && /*#__PURE__*/createElement(Menu.Item, {
      key: nodeType,
...
function withHrEvents(editor) {
  return function (event) {
    ...
    var _getNodeEntryFromSele = getNodeEntryFromSelection(editor, BLOCKS.HR),
...
function ToolbarHrButton(props) {
  ...
  }, /*#__PURE__*/createElement(HorizontalRuleIcon, null));
}
function Hr(props) {
  var isSelected = useSelected();
...
var LINK_TYPE_SELECTION_VALUES = (_LINK_TYPE_SELECTION_ = {}, _LINK_TYPE_SELECTION_[INLINES.HYPERLINK] = 'URL', _LINK_TYPE_SELECTION_[INLINES.ENTRY_HYPERLINK] = 'Entry', _LINK_TYPE_SELECTION_[INLINES.ASSET_HYPERLINK] = 'Asset', _LINK_TYPE_SELECTION_);
function HyperlinkModal(props) {
  ...
  var _React$useState = useState((_props$linkText = props.linkText) != null ? _props$linkText : ''),
      linkText = _React$useState[0],
      setLinkText = _React$useState[1];

  var _React$useState2 = useState((_props$linkType = props.linkType) != null ? _props$linkType : defaultLinkType),
      linkType = _React$useState2[0],
      setLinkType = _React$useState2[1];

  var _React$useState3 = useState((_props$linkTarget = props.linkTarget) != null ? _props$linkTarget : ''),
      linkTarget = _React$useState3[0],
      setLinkTarget = _React$useState3[1];

  var _React$useState4 = useState((_props$linkEntity = props.linkEntity) != null ? _props$linkEntity : null),
      linkEntity = _React$useState4[0],
      setLinkEntity = _React$useState4[1];

  function isLinkComplete() {
    var isRegularLink = linkType === INLINES.HYPERLINK;
  ...
  return /*#__PURE__*/createElement(EntityProvider, {
  ...
  })), enabledLinkTypes.length > 1 && /*#__PURE__*/createElement(FormControl, {
    id: "link-type"
  }, /*#__PURE__*/createElement(FormControl.Label, null, "Link type"), /*#__PURE__*/createElement(Select, {
    value: linkType,
    onChange: function onChange(event) {
  ...
  }))), linkType === INLINES.HYPERLINK && /*#__PURE__*/createElement(FormControl, {
    id: "linkTarget",
    isRequired: true
  }, /*#__PURE__*/createElement(FormControl.Label, null, "Link target"), /*#__PURE__*/createElement(TextInput, {
    name: "linkTarget",
    value: linkTarget,
    onChange: function onChange(event) {
      setLinkEntity(null);
    ...
    isDisabled: true,
    isSelected: false
  }), linkType === INLINES.ASSET_HYPERLINK && /*#__PURE__*/createElement(FetchingWrappedAssetCard, {
    sdk: props.sdk,
    locale: props.sdk.field.locale,
    assetId: linkEntity.sys.id,
    isDisabled: true,
    isSelected: false
  }))) : /*#__PURE__*/createElement("div", null, linkType === INLINES.ENTRY_HYPERLINK && /*#__PURE__*/createElement(TextLink, {
    testId: "entity-selection-link",
    onClick: selectEntry
  }, "Select entry"), linkType === INLINES.ASSET_HYPERLINK && /*#__PURE__*/createElement(TextLink, {
    testId: "entity-selection-link",
    onClick: selectAsset
  }, "Select asset"))))), /*#__PURE__*/createElement(ModalControls, null, /*#__PURE__*/createElement(Button, {
    type: "button",
    onClick: function onClick() {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            return ModalDialogLauncher.openDialog({
              ...
              return /*#__PURE__*/createElement(HyperlinkModal, {
                linkTarget: linkTarget,
...
var ListUL = /*#__PURE__*/createList('ul', BLOCKS.UL_LIST);
...
function ToolbarListButton(props) {
  ...
  if (!editor) return null;
  return /*#__PURE__*/createElement(Fragment, null, isNodeTypeEnabled(sdk.field, BLOCKS.UL_LIST) && /*#__PURE__*/createElement(ToolbarButton, {
    title: "UL",
...
function ToolbarQuoteButton(props) {
  ...
  }, /*#__PURE__*/createElement(QuoteIcon, null));
}
...
var TableActions = function TableActions() {
  ...
  return /*#__PURE__*/React__default.createElement(Menu, {
    ...
    onClose: close
  }, /*#__PURE__*/React__default.createElement(Menu.Trigger, null, /*#__PURE__*/React__default.createElement(IconButton, {
    size: "small",
    variant: "transparent",
    tabIndex: -1,
  ...
  })), /*#__PURE__*/React__default.createElement(Menu.List, null, /*#__PURE__*/React__default.createElement(Menu.Item, {
    onClick: action(addRowAbove, 'insert', 'Row'),
    disabled: !canInsertRowAbove
  }, "Add row above"), /*#__PURE__*/React__default.createElement(Menu.Item, {
    onClick: action(addRowBelow, 'insert', 'Row')
  }, "Add row below"), /*#__PURE__*/React__default.createElement(Menu.Item, {
    onClick: action(addColumnLeft, 'insert', 'Column')
  }, "Add column left"), /*#__PURE__*/React__default.createElement(Menu.Item, {
    onClick: action(addColumnRight, 'insert', 'Column')
  }, "Add column right"), /*#__PURE__*/React__default.createElement(Menu.Divider, null), /*#__PURE__*/React__default.createElement(Menu.Item, {
    onClick: toggleHeader
  }, isHeaderEnabled ? 'Disable table header' : 'Enable table header'), /*#__PURE__*/React__default.createElement(Menu.Divider, null), /*#__PURE__*/React__default.createElement(Menu.Item, {
    onClick: action(deleteRow, 'remove', 'Row')
  }, "Delete row"), /*#__PURE__*/React__default.createElement(Menu.Item, {
    onClick: action(deleteColumn, 'remove', 'Column')
  }, "Delete column"), /*#__PURE__*/React__default.createElement(Menu.Item, {
...
var styles$k = {
  ...
  hiddenToolbar: /*#__PURE__*/css({
    borderTop: STYLE_EDITOR_BORDER
  }),
  enabled: /*#__PURE__*/css({
    background: tokens.colorWhite,
    a: {
      span: {
        cursor: 'pointer',
...
function EmbeddedEntityDropdownButton(_ref) {
  ...
  return /*#__PURE__*/createElement(Menu, {
    ...
    variant: "secondary",
    size: "small",
    startIcon: /*#__PURE__*/createElement(PlusIcon, null),
    isDisabled: isDisabled
  }, "Embed")), /*#__PURE__*/createElement(Menu.List, {
...
var styles$l = {
  ...
  formattingOptionsWrapper: /*#__PURE__*/css({
    display: ['-webkit-box', '-ms-flexbox', 'flex'],
    msFlexAlign: 'center',
...
function getValidationInfo(field) {
  ...
  var isAnyMarkEnabled = someWithValidation(Object.values(MARKS), isMarkEnabled);
  var isAnyHyperlinkEnabled = someWithValidation([INLINES.HYPERLINK, INLINES.ASSET_HYPERLINK, INLINES.ENTRY_HYPERLINK], isNodeTypeEnabled);
  var isAnyBlockFormattingEnabled = someWithValidation([BLOCKS.UL_LIST, BLOCKS.OL_LIST, BLOCKS.QUOTE, BLOCKS.HR], isNodeTypeEnabled);
  return {
...
var HyperlinkDialog = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(EntityProvider, {
      sdk: this.props.sdk
    }, /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(ModalContent, null, this.renderFields()), /*#__PURE__*/React__default.createElement(ModalControls, null, /*#__PURE__*/React__default.createElement(Button, {
      type: "button",
      onClick: function onClick() {
  ...
  _proto.renderFields = function renderFields() {
    ...
    return /*#__PURE__*/React__default.createElement(Form, null, hideText ? null : /*#__PURE__*/React__default.createElement(FormControl, {
      id: "link-text",
      isRequired: true
    }, /*#__PURE__*/React__default.createElement(FormControl.Label, null, "Link text"), /*#__PURE__*/React__default.createElement(TextInput, {
      testId: "link-text-input",
      name: "link-text",
      value: text || '',
      ...
      id: "link-type",
      name: "link-type"
    }, /*#__PURE__*/React__default.createElement(FormControl.Label, null, "Link type"), /*#__PURE__*/React__default.createElement(Select, {
      value: type,
      onChange: function onChange(e) {
        return _this3.setState({
          type: e.target.value
    ...
    }, allowedHyperlinkTypes.includes(LINK_TYPES$1.URI) || type === LINK_TYPES$1.URI ? /*#__PURE__*/React__default.createElement(Select.Option, {
      value: LINK_TYPES$1.URI
    }, "URL") : null, allowedHyperlinkTypes.includes(LINK_TYPES$1.ENTRY) || type === LINK_TYPES$1.ENTRY ? /*#__PURE__*/React__default.createElement(Select.Option, {
      value: LINK_TYPES$1.ENTRY
    }, "Entry") : null, allowedHyperlinkTypes.includes(LINK_TYPES$1.ASSET) || type === LINK_TYPES$1.ASSET ? /*#__PURE__*/React__default.createElement(Select.Option, {
      value: LINK_TYPES$1.ASSET
    }, "Asset") : null)), type === LINK_TYPES$1.URI ? /*#__PURE__*/React__default.createElement(FormControl, {
      id: "link-uri",
      isRequired: true
    }, /*#__PURE__*/React__default.createElement(FormControl.Label, null, "Link target"), /*#__PURE__*/React__default.createElement(TextInput, {
      testId: "link-target-input",
      name: "link-uri",
      value: uri || '',
      placeholder: "https://",
  ...
  _proto.renderEntityField = function renderEntityField() {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(FormLabel, {
      required: true,
      htmlFor: ""
    }, "Link target"), !isEntitySelectorVisible && /*#__PURE__*/React__default.createElement(TextLink, {
      as: "button",
      className: css({
  ...
  _proto.renderEntitySelector = function renderEntitySelector(type) {
    ...
    }, type === LINK_TYPES$1.ENTRY && /*#__PURE__*/React__default.createElement(TextLink, {
      as: "button",
      onClick: this.selectEntry
    }, "Select entry"), type === LINK_TYPES$1.ASSET && /*#__PURE__*/React__default.createElement(TextLink, {
      as: "button",
...
export { ConnectedRichTextEditor, RichTextEditor, openRichTextDialog, renderRichTextDialog };
//# sourceMappingURL=field-editor-rich-text.esm.js.map
